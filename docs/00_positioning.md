...
Paper 1A defines and evaluates when a presenteeism support system transforms from self-support into surveillance, evaluation, or imposed labeling. The artifact in this repository is therefore:
...
> Under what design conditions does support for people working or studying while unwell become surveillance, evaluation, or imposed labeling?

The study decomposes three factors:
